...
const PostDetails = () => {
    ...
    const addLikeHandle = async(commentId) => {
      addLike(commentId);
    }
    ...
    const handleAddToCollection = async(e) => {
      try {
        const response2 = await addPostToCollection(collection, {"postId": postDetails.postDTO.id} )
                                  ...
                                  <div class="card-header p-1">
                                    <div class="row">
                                      ...
                                      <div className="col-3 text-end">
                                        <button class="btn" onClick={() => addLikeHandle(comment.commentDTO.id)}>
