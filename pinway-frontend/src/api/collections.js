...
export const postCollection = async (data) => {
  const response = await API.post(`/api/collections`, data ,{ headers: { Authorization: `Bearer eyJhbGciOiJIUzUxMiJ9.eyJyb2xlIjpbIlJPTEVfVVNFUiJdLCJzdWIiOiJlYmFzaWMiLCJpYXQiOjE2ODYzMzIyMTUsImV4cCI6MTY4NjY5MjIxNX0.sQuhchdEPaC-H1j1RzFyCtCNWyCjWTYOI0wF3yqBARjwjl4v4xAWGydWs-CulyjxPlLaZeHtZr-RQJU6R6F3Pw` } });
  return response.data;
}
